...
waypoints=[
    ...
    (-0.451, -2.816, 0.996, 0.089), #B
    (-3.582, -2.980 , -1.000, 0.008), #C
    (-1.971, -5.359, 0.156, 0.998), #D
    # (0.808, -0.195, 1.000, -0.018)  #end
    # (0.776, -0.294, 0.910, -0.414)
    (0.053, -0.058, 0.664, 0.748)
]
# waypoints=[
#     # (0.819, 2.741, 0.713, 0.701),
#     # (0.733, 3.984, 0.975, 0.223),
...
#     # (0.819, 2.741, 0.713, 0.701),
#     # (0.733, 3.984, 0.975, 0.223),
#     (3.990, 4.491, -0.702,  0.713), #B
#     (3.932, 2.626, -0.353,  0.979), #C
#     (3.813, 0.812, 0.702,  0.712), #D
#     # (0.808, -0.195, 1.000, -0.018)  #end
#     (0.776, -0.294, 0.910, -0.414)
