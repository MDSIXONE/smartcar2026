...
{ 
	...
	ndHandle.param("source_path", source_path, std::string("/home/ucar/ucar_ws/src/xf_mic_asr_offline"));
	ndHandle.param("/appid", appid, std::string("75d06121"));//appid，需要更换为自己的
