                            ...
                            costmap_2d::Costmap2DROS* costmap_ros)
{
    ...
    laser_points_pub_ = canonical_nh.advertise<sensor_msgs::PointCloud2>("laser_points", 1);
    candidate_trajectories_pub_ = canonical_nh.advertise<visualization_msgs::MarkerArray>(
        "candidate_trajectories", 1);
    selected_trajectory_pub_ = canonical_nh.advertise<visualization_msgs::Marker>(
        "selected_trajectory", 1);
    lookahead_footprint_pub_ = canonical_nh.advertise<visualization_msgs::Marker>(
        "lookahead_footprint", 1, true);
    safety_state_pub_ = canonical_nh.advertise<std_msgs::String>("safety_state", 1, true);
