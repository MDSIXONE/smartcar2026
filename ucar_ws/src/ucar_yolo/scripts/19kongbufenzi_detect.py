...
def main(network, class_names, class_colors):
    global yolo_start_flag 
    clear_result()
    # args = parser()
    rospy.loginfo("start detecting CS GO")
...
def callback_yolo_start(msg):
    ...
    main(network, class_names, class_colors)
...
if __name__ == "__main__":
    try:
        ...
        "/home/ucar/ucar_ws/src/ucar_yolo/scripts/9.weights",
        batch_size=1)
