...
> 本文件是 `.opencode/skills/ucar-lingo/SKILL.md` 的词典正文。AI 在对话中遇到
...
- **权威来源**：`docs/new-computer-gui-simulation-mission.md` §7、`docs/operations.md`「2026 双物品主流程」
...
- **权威来源**：`docs/operations.md`「USB 扬声器音量」
