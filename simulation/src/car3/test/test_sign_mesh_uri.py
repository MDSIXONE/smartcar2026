#!/usr/bin/env python3
"""Regression test for the official Gazebo scene-label mesh URIs."""
...
class SignMeshUriTest(unittest.TestCase):
    def test_scene_labels_keep_the_official_resource_paths(self):
        ...
        for model_name, mesh_name in expected_meshes.items():
            ...
            self.assertEqual(
                ...
                "/".join(
                    (
                        "file:///home/ucar/gazebo_ws/src/car3/models/sign/meshes",
                        mesh_name,
                    )
                ),
            )
