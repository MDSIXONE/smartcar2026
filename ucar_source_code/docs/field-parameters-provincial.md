...
| `OCR停车距离`、`内墙停车偏移` | `ocr_stop_offset_m=0.40` | OCR 识别后，车辆停在内墙交点向场内偏移 40cm，并在墙面法向 +45° 到 -45° 范围内二次识别。 | `ucar_2026/launch/2026.launch` |
...
| 参数 | 当前值 / 说明 |
| --- | --- |
| `ocr_stop_offset_m` | `0.40 m`，OCR 识别后停在内墙交点向场内偏移的位置，并在墙面法向 +45° 到 -45° 范围内二次识别 |
