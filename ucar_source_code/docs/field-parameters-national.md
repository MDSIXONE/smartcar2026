...
| `OCR停车距离`、`内墙停车偏移` | `ocr_stop_offset_m=0.25`、`ocr_recheck_backoff_m=0.25` | 先停在墙内 25cm，再普通导航到后方 25cm 验证位，在墙面法向 -45° 到 +45° 范围内二次识别；确认后回到认定停车区，车尾朝挡板停车。 | `ucar_2026_national/launch/2026.launch` |
