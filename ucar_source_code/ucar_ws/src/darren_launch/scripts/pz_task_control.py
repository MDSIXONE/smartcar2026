...
def judge_room():
    ...
    ## 判断B房间
    result[0], find_index = function_judge_vegetation(photo_B)
    if find_index != -1:
        room_find_flag[find_index] = 1
    ## 判断C房间
    result[1], find_index = function_judge_vegetation(photo_C)
    if find_index != -1:
        room_find_flag[find_index] = 1
    ## 判断D房间
    result[2], find_index = function_judge_vegetation(photo_D)
    if find_index != -1:
        room_find_flag[find_index] = 1
    ## 判断E房间
    result[3], find_index = function_judge_vegetation(photo_E)
    if find_index != -1:
        room_find_flag[find_index] = 1
    ## 判断F房间
...
class task_control:
    ...
    def yolo_vegetation_start(self,times):
