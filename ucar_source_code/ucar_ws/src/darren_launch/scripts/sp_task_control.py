...
waypoints=[
    ...
    (-0.834, -3.341,-0.999, 0.041),#E房间
    # (-0.742, -3.354,-0.324, 0.946), #E房间
    # (-3.782, -3.162,-0.999, 0.055), #D房间
    (-3.957, -3.126,-1.000, 0.004),#D房间现场
    # (-2.319, -5.381,0.011, 1.000), #C房间
    # (-2.202, -5.279,0.034, 0.999), #C房间现场
    # (-2.143, -4.862,0.043, 0.999),#C房间现场1
    (-1.786, -5.139,0.089, 0.996),#C
    # (-3.707, -5.280,-1.000, 0.019),#B房间
    # (-3.978, -5.142,-1.000, 0.025),#B房间现场
    (-4.239, -4.977,-1.000, 0.024),#B房间现场1
        ...
        while True:
            if task.get_task_start_flag():
                for index, pose in enumerate(waypoints, 1):
                    ...
                    if index == 1:
                        task.darknet_yolo_write(11,500) 
                        ...
                        task.darknet_yolo_write(12,500) 
                        ...
                        task.darknet_yolo_write(13,500) 
                        ...
                        task.darknet_yolo_write(14,500) 
                        ...
                        pass
                        task.yolo_fruit_start(20)
                        # task.yolo_vegetation_start()
                    elif index == 12:
                        pass
                    elif index == 13:  #12
                        # while True:
