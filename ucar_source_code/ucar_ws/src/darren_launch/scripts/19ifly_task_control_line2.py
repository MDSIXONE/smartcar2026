                         ...
                         for _ in range(10):
                            ...
                            if task.yolo_over_flag == 1:
                                ...
                                if obj in labels:
                                    ...
                                    if abs(x_center - 320) < 40:
                                        task.start_mission()
                                        task.report_result("我已取到{}".format(report_item))
                                        rospy.sleep(2)
                                        break
                                    else:
                                        ...
                                        if new_pose:
                                            ...
                                            #client.send_goal(new_pose)
                                            #client.wait_for_result() 
                                            rospy.sleep(2)
                                else:
                                    new_pose = task.calculate_new_pose(60)
                                    if new_pose:
                                         task.send_new_goal(new_pose)
                                         #client.send_goal(new_pose)
                                         #client.wait_for_result()
                            ...
                            #         angle_offset = int(calculate_angle(x_center))
                            #         rospy.loginfo(f'rotate{angle_offset}')
                            #         task.rotate(angle_offset)
                            #         rospy.sleep(1)
                            #         task.start_mission()
