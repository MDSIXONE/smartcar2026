...
def image_callback(msg):
    ...
    try:
        if start_flag==1:
            ...
            filename = "/home/ucar/temp/cam_out2.png"
...
rospy.init_node('image_listener_traffic')
image_sub = rospy.Subscriber("/usb_cam/image_raw", Image,image_callback)
cmd = rospy.Subscriber("/yolo_start_flag2", Int8,yolo_start_callback)
out = rospy.Publisher("/yolo_result2", Int32,queue_size=2)
out_ex = rospy.Publisher("/yolo_result_ex2", Int32,queue_size=2)
import time
import os
import subprocess
...
process=subprocess.Popen(["/home/ucar/yolov3/darknet_gpu/darknet","detector","test","/home/ucar/yolov3/darknet_gpu/data2/obj.data","/home/ucar/yolov3/darknet_gpu/cfg/yolov3-tiny-2.cfg","/home/ucar/yolov3/darknet_gpu/traffic-721.weights","-thresh","0.45"],stdout=subprocess.PIPE,stdin=subprocess.PIPE,cwd="/home/ucar/yolov3/darknet_gpu")
...
while not rospy.is_shutdown():
    ...
    process.stdin.write(b"/home/ucar/temp/cam_out2.png\n")
    process.stdin.flush()
    first=False
    key=-1
    value=-1
