...
python2_runner="$HOME/ucar_ws/src/ucar_2026_extra/scripts/run_melodic_python2.sh"
...
"$python2_runner" /opt/ros/melodic/bin/roscore \
  >"$HOME/.ros/ucar_2026_extra_roscore.log" 2>&1 &
roscore_pid=$!
...
case "$launch_mode" in
  ...
  manual)
    ...
    run_launch ucar_2026_extra 2026.launch
    ;;
  mission)
    ...
    run_launch ucar_2026_extra 2026.launch task_enabled:=true \
